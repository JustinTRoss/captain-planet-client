...
module.exports = function(callback) {
  ...
  stepRepo = function() {
    ...
    ;(outputDirectory = path.resolve(
      release.outputRoot + component
    )), (capitalizedComponent =
      component.charAt(0).toUpperCase() + component.slice(1)), (repoName =
      release.componentRepoRoot + capitalizedComponent), (gitOptions = {
      cwd: outputDirectory
    }), (pullOptions = {
      args: '-q',
      cwd: outputDirectory,
      ...
      'https://github.com/' + release.org + '/' + repoName + '.git'), (repoURL =
      'https://github.com/' +
      release.org +
      '/' +
      repoName +
