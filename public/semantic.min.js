...
!(function(e, t, n, i) {
    ...
    return (o = {
      ...
      fix: {
        ...
        consoleClear: function() {
          o.debug(
            'Disabling programmatic console clearing'
          ), (t.console.clear = function() {})
        },
        requestAnimationFrame: function() {
          o.debug('Normalizing requestAnimationFrame'), void 0 ===
      ...
      change: {
        setting: function(t, n, i, a) {
          ;(i =
            'string' == typeof i
              ? 'all' === i ? d.modules : [i]
              : i || d.modules), (a = void 0 === a || a), e.each(i, function(
            i,
            r
          ) {
            var s,
        ...
        settings: function(t, n, i) {
          ;(n = 'string' == typeof n ? [n] : n || d.modules), (i =
            void 0 === i || i), e.each(n, function(n, a) {
            var r
            o.moduleExists(a) &&
              (
      ...
      enable: {
        ...
        debug: function(e, t) {
          ;(e = e || d.modules), o.debug(
            'Enabling debug for modules',
            e
      ...
      console: function(e) {
        if (e) {
          ...
          o.debug('Disabling console function'), (b.cache.console =
            t.console), (t.console = {
            clear: function() {},
            error: function() {},
            group: function() {},
      ...
      performance: {
        ...
        display: function() {
          var t = d.name + ':',
            n = 0
          ;(r = !1), clearTimeout(o.performance.timer), e.each(s, function(
            e,
            t
          ) {
            n += t['Execution Time']
          }), (t += ' ' + n + 'ms'), (void 0 !== console.group ||
      ...
      invoke: function(t, n, i) {
        var r,
          ...
          l,
          c = b
        return (n = n || u), (i = h || i), 'string' == typeof t &&
          void 0 !== c &&
          (
            (t = t.split(/[\. ]/)),
            (r = t.length - 1),
          ...
          ? (l = s.apply(i, n))
          : void 0 !== s && (l = s), e.isArray(a)
          ? a.push(l)
          : void 0 !== a ? (a = [a, l]) : void 0 !== l && (a = l), s
      }
    }), c
      ? (void 0 === b && o.initialize(), o.invoke(l))
      : (void 0 !== b && o.destroy(), o.initialize()), void 0 !== a ? a : this
  }), (e.site.settings = {
    name: 'Site',
    namespace: 'site',
    error: {
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.form = function(t) {
    var i,
      o = e(this),
      a = o.selector || '',
      r = new Date().getTime(),
    ...
    return o.each(function() {
      ...
      ;(F = {
        ...
        destroy: function() {
          F.verbose(
            'Destroying previous module',
            E
          ), F.removeEvents(), O.removeData(R)
        },
        refresh: function() {
          F.verbose('Refreshing selector cache'), (f = O.find(
            w.field
          )), (m = O.find(w.group)), (g = O.find(w.message)), (v = O.find(
            w.prompt
          )), (p = O.find(w.submit)), (h = O.find(w.clear)), (b = O.find(
            w.reset
          ))
        },
        submit: function() {
        ...
        bindEvents: function() {
          F.verbose('Attaching form events'), O.on(
            'submit' + P,
            F.validate.form
          )
            ...
            .on('click' + P, w.clear, F.clear), y.keyboardShortcuts &&
            O.on(
              'keydown' + P,
              w.field,
        ...
        get: {
          ...
          fieldsFromShorthand: function(t) {
            ...
            return e.each(t, function(t, i) {
              'string' == typeof i &&
                (i = [i]), (n[t] = { rules: [] }), e.each(i, function(e, i) {
          ...
          prompt: function(e, t) {
            var n,
              ...
              l = s.search('{value}') !== -1,
              c = s.search('{name}') !== -1
            return (c || l) && (i = F.get.field(t.identifier)), l &&
              (s = s.replace('{value}', i.val())), c &&
              (
                ...
                (s = s.replace('{name}', o))
              ), (s = s.replace('{identifier}', t.identifier)), (s = s.replace(
              '{ruleValue}',
              r
            )), e.prompt ||
              F.verbose('Using default validation prompt for type', s, a), s
          },
          settings: function() {
            if (e.isPlainObject(t)) {
              ...
              (y = e.fn.form.settings), (x =
                e.fn.form.settings.defaults), F.verbose(
                'Using default form validation',
                x,
                y
              )
            ;(A = y.namespace), (C = y.metadata), (w = y.selector), (k =
              y.className), (S = y.regExp), (T = y.error), (R =
              'module-' + A), (P = '.' + A), (E = O.data(R)), F.refresh()
          },
          field: function(t) {
            return F.verbose(
              'Finding field with identifier',
              t
            ), (t = F.escape.string(t)), f.filter('#' + t).length > 0
              ? f.filter('#' + t)
            ...
            return (
              ...
              (
                e.each(x, function(e, o) {
                  ;(i =
                    o.identifier ||
                    e), F.get.field(i)[0] == t[0] && ((o.identifier = i), (n = o))
                }),
                n || !1
              )
            )
        ...
        has: {
          field: function(e) {
            return F.verbose(
              ...
              e
            ), (e = F.escape.string(e)), 'string' != typeof e &&
              F.error(T.identifier, e), f.filter('#' + e).length > 0 ||
        ...
        add: {
          ...
          prompt: function(t, n) {
            var i = F.get.field(t),
              ...
              r = 0 !== a.length
            ;(n = 'string' == typeof n ? [n] : n), F.verbose(
              'Adding field error state',
              t
            ), o.addClass(k.error), y.inline &&
              (
          ...
          errors: function(e) {
            F.debug('Adding form error messages', e), F.set.error(), g.html(
              y.templates.error(e)
            )
          }
        },
        remove: {
          rule: function(t, n) {
            ...
            void 0 != x[t] &&
              ...
              e.each(x[t].rules, function(e, n) {
                i.indexOf(n.type) !== -1 &&
                  (F.debug('Removed rule', n.type), x[t].rules.splice(e, 1))
              })
          },
          field: function(t) {
          ...
          prompt: function(t) {
            ...
            i.removeClass(k.error), y.inline &&
              o.is(':visible') &&
              (
                  ...
                  (r && s
                    ? (
                        ...
                        e.each(n, function(e, t) {
                          ;(i = o.filter(
                            '[value="' + t + '"]'
                          )), (a = i.parent()), i.length > 0 && a.checkbox('check')
                        })
                      )
                    : c
                      ? (
        ...
        performance: {
          ...
          display: function() {
            var t = y.name + ':',
              n = 0
            ;(r = !1), clearTimeout(F.performance.timer), e.each(s, function(
              e,
              t
            ) {
              n += t['Execution Time']
            }), (t += ' ' + n + 'ms'), a && (t += " '" + a + "'"), o.length >
              1 && (t += ' (' + o.length + ')'), (void 0 !== console.group ||
              void 0 !== console.table) &&
              s.length > 0 &&
              (
                console.groupCollapsed(t),
        ...
        invoke: function(t, n, o) {
          var a,
            ...
            s,
            l = E
          return (n = n || d), (o = D || o), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
            ...
            ? (s = r.apply(o, n))
            : void 0 !== r && (s = r), e.isArray(i)
            ? i.push(s)
            : void 0 !== i ? (i = [i, s]) : void 0 !== s && (i = s), r
        }
      }), F.initialize()
    }), void 0 !== i ? i : this
  }), (e.fn.form.settings = {
    ...
    rules: {
      ...
      is: function(e, t) {
        return (t = 'string' == typeof t ? t.toLowerCase() : t), (e =
          'string' == typeof e ? e.toLowerCase() : e) == t
      },
      isExactly: function(e, t) {
        return e == t
      },
      not: function(e, t) {
        return (e = 'string' == typeof e ? e.toLowerCase() : e), (t =
          'string' == typeof t ? t.toLowerCase() : t), e != t
      },
      ...
      exactCount: function(e, t) {
        return 0 == t
          ? '' === e
          : 1 == t ? '' !== e && e.search(',') === -1 : e.split(',').length == t
      },
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.accordion = function(n) {
    var i,
      o = e(this),
      a = new Date().getTime(),
      r = [],
    ...
    return o.each(function() {
      ...
      ;(d = {
        initialize: function() {
          d.debug('Initializing', x), d.bind.events(), f.observeChanges &&
            d.observeChanges(), d.instantiate()
        },
        instantiate: function() {
          ;(S = d), x.data(b, d)
        },
        ...
        bind: {
          events: function() {
            d.debug('Binding delegated events'), x.on(
              f.on + h,
              v.trigger,
              d.event.click
            )
        ...
        toggle: function(t) {
          var n =
            ...
            r = a && !o,
            s = !a && o
          d.debug('Toggling visibility of content', n), r || s
            ? f.collapsible
              ? d.close.call(n)
        ...
        open: function(t) {
          ...
          d.debug('Opening accordion content', n), f.onOpening.call(
            i
          ), f.exclusive && d.closeOthers.call(n), n.addClass(m.active), i
            .stop(!0, !0)
            .addClass(m.animating), f.animateChildren &&
            ...
            i
              ...
              .addClass(
                m.active
              ), d.reset.display.call(this), f.onOpen.call(this), f.onChange.call(this)
          })
        },
        close: function(t) {
          var n =
            ...
            (
              ...
              i.slideUp(f.duration, f.easing, function() {
                i
                  ...
                  .removeClass(
                    m.active
                  ), d.reset.display.call(this), f.onClose.call(this), f.onChange.call(this)
              })
            )
        },
        ...
        reset: {
          display: function() {
            d.verbose('Removing inline display from element', this), e(
              this
            ).css('display', ''), '' === e(this).attr('style') &&
              e(this).attr('style', '').removeAttr('style')
          },
          opacity: function() {
            d.verbose('Removing inline opacity from element', this), e(
              this
            ).css('opacity', ''), '' === e(this).attr('style') &&
              e(this).attr('style', '').removeAttr('style')
          }
        },
        setting: function(t, n) {
        ...
        performance: {
          ...
          display: function() {
            var t = f.name + ':',
              n = 0
            ;(a = !1), clearTimeout(d.performance.timer), e.each(r, function(
              e,
              t
            ) {
              n += t['Execution Time']
        ...
        invoke: function(t, n, o) {
          var a,
            ...
            s,
            l = S
          return (n = n || c), (o = k || o), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.checkbox = function(i) {
    var o,
      a = e(this),
      r = a.selector || '',
      s = new Date().getTime(),
      ...
      ;(f = {
        initialize: function() {
          f.verbose(
            ...
            m
          ), f.create.label(), f.bind.events(), f.set.tabbable(), f.hide.input(), f.observeChanges(), f.instantiate(), f.setup()
        },
        instantiate: function() {
        ...
        setup: function() {
          f.set.initialLoad(), f.is.indeterminate()
        ...
        attachEvents: function(t, n) {
          var i = e(t)
          ;(n = e.isFunction(f[n]) ? f[n] : f.toggle), i.length > 0
            ? (
        ...
        indeterminate: function() {
          ...
          ), f.set.indeterminate(), f.should.ignoreCallbacks() ||
        ...
        determinate: function() {
          ...
          f.debug(
            'Making checkbox determinate'
          ), f.set.determinate(), f.should.ignoreCallbacks() ||
            (m.onDeterminate.call(k), m.onChange.call(k))
        },
        enable: function() {
          if (f.is.enabled()) return void f.debug('Checkbox is already enabled')
          f.debug('Enabling checkbox'), f.set.enabled(), m.onEnable.call(
            k
          ), m.onEnabled.call(k)
        },
        disable: function() {
          ...
          f.debug('Disabling checkbox'), f.set.disabled(), m.onDisable.call(
            k
          ), m.onDisabled.call(k)
        },
        get: {
        ...
        set: {
          ...
          checked: function() {
            ...
            f.verbose('Setting state to checked', k), w
              .prop('indeterminate', !1)
              .prop('checked', !0), f.trigger.change()
          },
          unchecked: function() {
            if (
              (
            ...
            f.debug('Setting state to unchecked'), w
              .prop('indeterminate', !1)
              .prop('checked', !1), f.trigger.change()
          },
          indeterminate: function() {
            if (
              (
            ...
            f.debug('Setting state to indeterminate'), w.prop(
              'indeterminate',
              !0
            ), f.trigger.change()
          },
          ...
          disabled: function() {
            ...
            f.debug('Setting state to disabled'), w.prop(
              'disabled',
              'disabled'
            ), f.trigger.change()
          },
          enabled: function() {
            ...
            f.debug('Setting state to enabled'), w.prop(
              'disabled',
              !1
            ), f.trigger.change()
          },
          tabbable: function() {
            f.verbose('Adding tabindex to checkbox'), void 0 ===
              w.attr('tabindex') && w.attr('tabindex', 0)
          }
        },
        remove: {
          initialLoad: function() {
        ...
        bind: {
          events: function() {
            f.verbose('Attaching checkbox events'), x
        ...
        performance: {
          ...
          display: function() {
            var t = m.name + ':',
              n = 0
            ;(s = !1), clearTimeout(f.performance.timer), e.each(l, function(
              e,
              t
            ) {
              n += t['Execution Time']
        ...
        invoke: function(t, n, i) {
          var a,
            ...
            s,
            l = A
          return (n = n || d), (i = R || i), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
            ...
            ? (s = r.apply(i, n))
            : void 0 !== r && (s = r), e.isArray(o)
            ? o.push(s)
            : void 0 !== o ? (o = [o, s]) : void 0 !== s && (o = s), r
        }
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.dimmer = function(t) {
    var i,
      o = e(this),
      a = new Date().getTime(),
      r = [],
      ...
      ;(f = {
        ...
        initialize: function() {
          f.debug(
            'Initializing dimmer',
            m
          ), f.bind.events(), f.set.dimmable(), f.instantiate()
        },
        instantiate: function() {
        ...
        destroy: function() {
          f.verbose(
            'Destroying previous module',
            u
          ), f.unbind.events(), f.remove.variation(), d.off(b)
        },
        bind: {
          events: function() {
            'hover' == m.on
              ? d.on('mouseenter' + b, f.show).on('mouseleave' + b, f.hide)
              : 'click' == m.on && d.on(C + b, f.toggle), f.is.page() &&
              (
        ...
        event: {
          click: function(t) {
            f.verbose('Determining if event occured on dimmer', t), (0 ===
              u.find(t.target).length ||
        ...
        addContent: function(t) {
          var n = e(t)
          f.debug('Add content to dimmer', n), n.parent()[0] !== u[0] &&
            n.detach().appendTo(u)
        },
        create: function() {
        ...
        show: function(t) {
          ;(t = e.isFunction(t) ? t : function() {}), f.debug(
            'Showing dimmer',
            u,
            m
        ...
        hide: function(t) {
          ;(t = e.isFunction(t) ? t : function() {}), f.is.dimmed() ||
          f.is.animating()
            ? (
        ...
        toggle: function() {
          f.verbose('Toggling dimmer visibility', u), f.is.dimmed()
            ? f.hide()
            : f.show()
        },
        animate: {
        ...
        set: {
          opacity: function(e) {
            var t = u.css('background-color'),
              ...
              i = n && 3 == n.length,
              o = n && 4 == n.length
            ;(e = 0 === m.opacity ? 0 : m.opacity || e), i || o
              ? ((n[3] = e + ')'), (t = n.join(',')))
              : (t = 'rgba(0, 0, 0, ' + e + ')'), f.debug(
              'Setting opacity to',
              e
        ...
        performance: {
          ...
          display: function() {
            var t = m.name + ':',
              n = 0
            ;(a = !1), clearTimeout(f.performance.timer), e.each(r, function(
              e,
              t
            ) {
              n += t['Execution Time']
            }), (t += ' ' + n + 'ms'), x && (t += " '" + x + "'"), o.length >
              1 && (t += ' (' + o.length + ')'), (void 0 !== console.group ||
              void 0 !== console.table) &&
              r.length > 0 &&
              (
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.dropdown = function(i) {
    var o,
      a = e(this),
      r = e(n),
      s = a.selector || '',
    ...
    return a.each(function(g) {
      ...
      ;(w = {
        initialize: function() {
          w.debug('Initializing dropdown', k), w.is.alreadySetup()
            ? w.setup.reference()
            : (
                w.setup.layout(),
        ...
        destroy: function() {
          w.verbose(
            'Destroying previous dropdown',
            I
          ), w.remove.tabbable(), I.off(j).removeData(z), B.off(j), r.off(
            b
          ), w.disconnect.menuObserver(), w.disconnect.selectObserver()
        },
        observeChanges: function() {
          'MutationObserver' in t &&
            (
        ...
        create: {
          id: function() {
            ;(y = (Math.random().toString(16) + '000000000').substr(2, 8)), (b =
              '.' + y), w.verbose('Creating unique id for element', y)
          },
        ...
        search: function(e) {
          ;(e = void 0 !== e ? e : w.get.query()), w.verbose(
            'Searching for query',
            e
        ...
        select: {
          firstUnfiltered: function() {
            ...
            ), w.remove.selectedItem(), Q.not(O.unselectable)
        ...
        setup: {
          ...
          layout: function() {
            I.is('select') &&
              (w.setup.select(), w.setup.returnedObject()), w.has.menu() ||
              w.create.menu(), w.is.search() &&
              !w.has.search() &&
              (
              ...
              !w.has.sizer() &&
              w.create.sizer(), k.allowTab && w.set.tabbable()
          },
          select: function() {
            var t = w.get.selectValues()
            w.debug('Dropdown initialized on a select', t), I.is('select') &&
              (H = I), H.parent(O.dropdown).length > 0
              ? (
                  w.debug(
          ...
          reference: function() {
            ...
            ), (I = I.parent(O.dropdown)), (K = I.data(z)), (Z = I.get(
              0
            )), w.refresh(), w.setup.returnedObject()
          },
        ...
        refreshSelectors: function() {
          w.verbose('Refreshing selector cache'), (L = I.find(
            O.text
          )), (V = I.find(O.search)), (H = I.find(O.input)), (U = I.find(
            O.icon
          )), (W =
            I.prev().find(O.text).length > 0
              ? I.prev().find(O.text)
              : I.prev()), (B = I.children(O.menu)), (Q = B.find(O.item))
        },
        refreshData: function() {
          w.verbose('Refreshing cached metadata'), Q.removeData(
            P.text
          ).removeData(P.value)
        },
        clearData: function() {
          w.verbose('Clearing metadata'), Q.removeData(P.text).removeData(
            P.value
        ...
        toggle: function() {
          w.verbose('Toggling menu visibility'), w.is.active()
            ? w.hide()
            : w.show()
        },
        show: function(t) {
          if (
            ...
            k.onShow.call(Z) !== !1 &&
              w.animate.show(function() {
                w.can.click() &&
                  w.bind.intent(), w.has.menuSearch() && w.focusSearch(), w.set.visible(), t.call(Z)
              })
          }
        },
        hide: function(t) {
          ;(t = e.isFunction(t) ? t : function() {}), w.is.active() &&
            (
        ...
        hideOthers: function() {
          w.verbose('Finding other dropdowns to hide'), a
            .not(I)
        ...
        hideMenu: function() {
          w.verbose(
            'Hiding menu  instantaneously'
          ), w.remove.active(), w.remove.visible(), B.transition('hide')
        },
        ...
        bind: {
          events: function() {
            l &&
              w.bind.touchEvents(), w.bind.keyboardEvents(), w.bind.inputEvents(), w.bind.mouseEvents()
          },
          touchEvents: function() {
            w.debug(
              ...
              (w.is.single() &&
                I.on('touchstart' + j, w.event.test.toggle)), B.on(
              'touchstart' + j,
              O.item,
          ...
          keyboardEvents: function() {
            w.verbose('Binding keyboard events'), I.on(
              'keydown' + j,
              w.event.keydown
            ), w.has.search() &&
              I.on(
          ...
          inputEvents: function() {
            w.verbose('Binding input change events'), I.on(
              'change' + j,
              O.input,
              w.event.change
            )
          ...
          mouseEvents: function() {
            w.verbose('Binding mouse events'), w.is.multiple() &&
          ...
          intent: function() {
            w.verbose('Binding hide intent event to document'), l &&
              r
                .on('touchstart' + b, w.event.test.touch)
                .on('touchmove' + b, w.event.test.touch), r.on(
              'click' + b,
              w.event.test.hide
            )
          }
        ...
        unbind: {
          intent: function() {
            w.verbose('Removing hide intent event from document'), l &&
              r.off('touchstart' + b).off('touchmove' + b), r.off('click' + b)
          }
        },
        filter: function(e) {
          var t = void 0 !== e ? e : w.get.query(),
            n = function() {
              w.is.multiple() && w.filterActive(), (e ||
                (!e && 0 == w.get.activeItem().length)) &&
                w.select.firstUnfiltered(), w.has.allResultsFiltered()
                ...
                : (w.remove.empty(), w.remove.message()), k.allowAdditions &&
                w.add.userSuggestion(e), w.is.searchSelection() &&
                w.can.show() &&
        ...
        queryRemote: function(t, n) {
          ...
          I.api('get request') || w.setup.api(), (i = e.extend(
            !0,
            {},
            i,
            k.apiSettings
        ...
        filterItems: function(t) {
          ...
          w.has.query() &&
            (
              ...
              Q.each(function() {
                ...
                if ('both' == k.match || 'text' == k.match) {
                  if (
                    ((t = String(w.get.choiceText(r, !1))), t.search(a) !== -1)
                  )
                    return i.push(this), !0
                  if ('exact' === k.fullTextSearch && w.exactSearch(n, t))
                    return i.push(this), !0
                  if (k.fullTextSearch === !0 && w.fuzzySearch(n, t))
                    return i.push(this), !0
                }
                if ('both' == k.match || 'value' == k.match) {
                  if (
                    ((o = String(w.get.choiceValue(r, t))), o.search(a) !== -1)
                  )
                    return i.push(this), !0
                  if ('exact' === k.fullTextSearch && w.exactSearch(n, o))
                    return i.push(this), !0
                  if (k.fullTextSearch === !0 && w.fuzzySearch(n, o))
                    return i.push(this), !0
                }
              })
            ), w.debug(
            ...
            n
          ), w.remove.filteredItem(), i && Q.not(i).addClass(S.filtered)
        },
        ...
        change: {
          values: function(t) {
            k.allowAdditions || w.clear(), w.debug(
              'Creating dropdown with specified values',
              t
            ), w.setup.menu({ values: t }), e.each(t, function(e, t) {
              if (1 == t.selected)
                return w.debug(
                  'Setting initial selection to',
                  t.value
                ), w.set.selected(t.value), !0
            })
          }
        },
        event: {
          ...
          search: {
            focus: function() {
              ;(X = !0), w.is.multiple() &&
                w.remove.activeLabel(), k.showOnFocus && w.search()
            },
            blur: function(e) {
              ;(p = n.activeElement === this), w.is.searchSelection() &&
                !h &&
                ($ ||
                  p ||
                  (k.forceSelection && w.forceSelection(), w.hide())), (h = !1)
            }
          },
          icon: {
            click: function(e) {
          ...
          input: function(e) {
            ;(w.is.multiple() || w.is.searchSelection()) &&
              w.set.filtered(), clearTimeout(w.timer), (w.timer = setTimeout(
              w.search,
              k.delay.search
            ))
          },
          ...
          item: {
            ...
            click: function(t, i) {
              var o = e(this),
                ...
                c = r.length > 0,
                u = r.find(a).length > 0
              w.has.menuSearch() && e(n.activeElement).blur(), u ||
                    ...
                    ? (
                        ...
                        r &&
                          (
                            ...
                            c
                              ? u
                                ? d ? n.removeClass(S.active) : w.focusSearch()
                                : s
            ...
            if (w.is.inObject(t, R)) {
              ...
              if (
                ...
                if (
                  ...
                  if (
                    (
                      (n =
                        d && c
                          ? a
                              .prevAll(O.item + ':not(' + O.unselectable + ')')
                              .eq(0)
                          : Q.eq(0)),
                      r.index(n) < 0
                    )
                  ...
                  ), a.removeClass(S.selected), n.addClass(
                    S.selected
                  ), w.set.scrollPosition(n), k.selectOnKeydown &&
                    w.is.single() &&
                    w.set.selectedItem(n), e.preventDefault()
                }
                if (t == R.downArrow) {
                  if (
                    (
                      (n =
                        d && c
                          ? (n = a
                              .nextAll(O.item + ':not(' + O.unselectable + ')')
                              .eq(0))
                          : Q.eq(0)),
                      0 === n.length
                    )
                  ...
                  ), Q.removeClass(S.selected), n.addClass(
                    S.selected
                  ), w.set.scrollPosition(n), k.selectOnKeydown &&
                    w.is.single() &&
                    w.set.selectedItem(n), e.preventDefault()
                }
                t == R.pageUp && (w.scrollPage('up'), e.preventDefault()), t ==
                  R.pageDown && (w.scrollPage('down'), e.preventDefault()), t ==
                  R.escape &&
                  (w.verbose('Escape key pressed, closing dropdown'), w.hide())
              } else
                m && e.preventDefault(), t != R.downArrow ||
                  w.is.visible() ||
                  (
        ...
        determine: {
          selectAction: function(t, n) {
            w.verbose('Determining action', k.action), e.isFunction(
              w.action[k.action]
            )
              ? (
          ...
          eventInModule: function(t, i) {
            ...
            return (i = e.isFunction(i) ? i : function() {}), a && !r
              ? (w.verbose('Triggering event', i), i(), !0)
              : (
                  w.verbose('Event occurred in dropdown, canceling callback'),
                  !1
                )
          },
          eventOnElement: function(t, i) {
            ...
            return (i = e.isFunction(i) ? i : function() {}), r && s && l
              ? (w.verbose('Triggering event', i), i(), !0)
              : (
                  w.verbose(
        ...
        action: {
          ...
          select: function(t, n, i) {
            if (((n = void 0 !== n ? n : t), w.can.activate(e(i)))) {
              if (
                (w.set.value(n, e(i)), w.is.multiple() && !w.is.allFiltered())
              )
                return
              w.hideAndClear()
            }
        ...
        get: {
          ...
          searchWidth: function(e) {
            return (e = void 0 !== e ? e : V.val()), N.text(e), Math.ceil(
              N.width() + 1
            )
          },
          ...
          choiceValue: function(t, n) {
            return (n = n || w.get.choiceText(t)), !!t &&
              (void 0 !== t.data(P.value)
                ? String(t.data(P.value))
                : 'string' == typeof n ? e.trim(n.toLowerCase()) : String(n))
          },
          inputEvent: function() {
            var e = V[0]
            return (
              ...
              (void 0 !== e.oninput
                ? 'input'
                : void 0 !== e.onpropertychange ? 'propertychange' : 'keyup')
            )
          },
          selectValues: function() {
            ...
            return (t.values = []), I.find('option').each(function() {
              ...
              : w.debug('Retrieved values from select', t), t
          },
          activeItem: function() {
        ...
        restore: {
          ...
          selected: function() {
            w.restore.values(), w.is.multiple()
              ? (
                  w.debug('Restoring previously selected values and labels'),
                  w.restore.labels()
                )
              : w.debug('Restoring previously selected values')
          },
          values: function() {
            w.set.initialLoad(), k.apiSettings &&
            k.saveRemoteData &&
            w.get.remoteValues()
              ? w.restore.remoteValues()
              : w.set.selected(), w.remove.initialLoad()
          },
          remoteValues: function() {
            var t = w.get.remoteValues()
            w.debug('Recreating selected from session data', t), t &&
              (w.is.single()
                ? e.each(t, function(e, t) {
                    w.set.text(t)
                  })
        ...
        scrollPage: function(e, t) {
          ...
          ;(o = 'up' == e ? f.index(a) - u : f.index(a) + u), (n =
            'up' == e ? o >= 0 : o < f.length), (i = n
            ? f.eq(o)
            : 'up' == e ? f.first() : f.last()), i.length > 0 &&
            (
        ...
        set: {
          ...
          placeholderText: function(e) {
            ;(e = e || w.get.placeholderText()), w.debug(
              'Setting placeholder text',
              e
            ), w.set.text(e), L.addClass(S.placeholder)
          },
          tabbable: function() {
            w.is.searchSelection()
              ? (
          ...
          scrollPosition: function(e, t) {
            ...
            ;(e = e || w.get.selectedItem()), (n = e.closest(O.menu)), (i =
              e && e.length > 0), (t = void 0 !== t && t), e &&
              n.length > 0 &&
              i &&
              (
                (a = e.position().top),
          ...
          selectedItem: function(e) {
            ...
            w.debug(
              'Setting user selection to item',
              e
            ), w.remove.activeItem(), w.set.partialSearch(n), w.set.activeItem(
              e
            ), w.set.selected(t, e), w.set.text(i)
          },
          ...
          value: function(e, t, n) {
            ...
            if (o) {
              if (
                ...
                r == a &&
                (
                  w.verbose('Skipping value update already same value', e, a),
                  !w.is.initialLoad()
                )
              )
                return
              w.is.single() &&
                ...
                (
                  ...
                  w.add.optionValue(e)
                ), w.debug('Updating input value', i, a), (Y = !0), H.val(
                i
              ), k.fireOnInit === !1 && w.is.initialLoad()
                ? w.debug('Input native change event ignored on initial load')
                : w.trigger.change(), (Y = !1)
            } else
              w.verbose('Storing value in metadata', i, H), i !== a &&
                I.data(P.value, r)
            k.fireOnInit === !1 && w.is.initialLoad()
          ...
          exactly: function(e, t) {
            w.debug(
              'Setting selected to exact values'
            ), w.clear(), w.set.selected(e, t)
          },
        ...
        add: {
          label: function(t, n, i) {
            ...
            k.label.variation && o.addClass(k.label.variation), i === !0
              ? (
            ...
            if (!k.useLabels || !w.has.maxSelections()) {
              ...
              a
                ...
                n
                  .addClass(S.selected)
                  .siblings()
                  .removeClass(S.selected), w.refreshItems()
            }
          },
          variables: function(e, t) {
            var n,
              ...
              r = e.search('{term}') !== -1
            return w.verbose('Adding templated variables to message', e), o &&
              (
              ...
              ((i = t || w.get.query()), (e = e.replace('{term}', i))), e
          },
          value: function(t, n, i) {
            ...
            e.isArray(a)
              ...
              : k.onAdd.call(Z, t, n, i), w.set.value(
              o,
              t,
              n,
              i
        ...
        remove: {
            ...
            n.each(function() {
              ...
              w.is.multiple()
                ...
                : w.remove.value(
                    ...
                    n,
                    t
                  ), t.removeClass(S.filtered).removeClass(S.active), k.useLabels && t.removeClass(S.selected)
            })
          },
          selectedItem: function() {
          ...
          value: function(e, t, n) {
            ...
            w.has.selectInput()
              ...
              : k.onRemove.call(Z, e, t, n), w.set.value(
              i,
              t,
              n
            ), w.check.maxSelections()
          ...
          activeLabels: function(e) {
            ;(e = e || I.find(O.label).filter('.' + S.active)), w.verbose(
              'Removing active label selections',
              e
            ), w.remove.labels(e)
          },
          labels: function(t) {
            ;(t = t || I.find(O.label)), w.verbose(
              'Removing labels',
              t
            ), t.each(function() {
              var t = e(this),
        ...
        is: {
          ...
          bubbledLabelClick: function(t) {
            return (
              e(t.target).is('select, input') && I.closest('label').length > 0
            )
          },
        ...
        can: {
          ...
          openDownward: function(e) {
            ...
            return n.addClass(S.loading), (t = {
              ...
              (t.menu.offset.top += t.context.scrollTop), (o = {
              ...
              : o.below || o.above
                ? (
                    w.verbose('Dropdown cannot fit below, opening upward', o),
                    (i = !1)
                  )
                : (
                    w.verbose(
          ...
          openRightward: function(e) {
            ...
            return n.addClass(S.loading), (t = {
              ...
              (t.menu.offset.left += t.context.scrollLeft), (o =
              t.menu.offset.left + t.menu.width >=
              t.context.scrollLeft + t.context.width), o &&
              (
        ...
        animate: {
          show: function(t, n) {
            ...
            ;(t = e.isFunction(t) ? t : function() {}), w.verbose(
              'Doing menu show animation',
              o
            ), w.set.direction(n), (i = w.get.transition(
              n
            )), w.is.selection() &&
              w.set.scrollPosition(w.get.selectedItem(), !0), (w.is.hidden(o) ||
              w.is.animating(o)) &&
              ('none' == i
          ...
          hide: function(t, n) {
            ...
            ;(t = e.isFunction(t) ? t : function() {}), (w.is.visible(i) ||
              w.is.animating(i)) &&
              (
        ...
        hideAndClear: function() {
          w.remove.searchTerm(), w.has.maxSelections() ||
            (w.has.search()
              ? w.hide(function() {
                  w.remove.filteredItem()
                })
        ...
        delay: {
          show: function() {
            ...
            ), clearTimeout(w.timer), (w.timer = setTimeout(
              w.show,
              k.delay.show
            ))
          },
        ...
        performance: {
          ...
          display: function() {
            var t = k.name + ':',
              n = 0
            ;(c = !1), clearTimeout(w.performance.timer), e.each(u, function(
              e,
              t
            ) {
              n += t['Execution Time']
        ...
        invoke: function(t, n, i) {
          var a,
            ...
            s,
            l = K
          return (n = n || m), (i = Z || i), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
    ...
    dropdown: function(t) {
      var n = t.placeholder || !1,
        i = (t.values, '')
      return (i += '<i class="dropdown icon"></i>'), t.placeholder
        ? (i += '<div class="default text">' + n + '</div>')
        : (i += '<div class="text"></div>'), (i +=
        '<div class="menu">'), e.each(t.values, function(e, t) {
        i += t.disabled
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.embed = function(n) {
    var i,
      o = e(this),
      a = o.selector || '',
      r = new Date().getTime(),
    ...
    return o.each(function() {
      ...
      ;(d = {
        initialize: function() {
          d.debug(
            'Initializing embed'
          ), d.determine.autoplay(), d.create(), d.bind.events(), d.instantiate()
        },
        instantiate: function() {
        ...
        destroy: function() {
          d.verbose(
            'Destroying previous instance of embed'
          ), d.reset(), w.removeData(C).off(x)
        },
        refresh: function() {
          d.verbose('Refreshing selector cache'), (k = w.find(
            m.placeholder
          )), (S = w.find(m.icon)), (T = w.find(m.embed))
        },
        bind: {
          events: function() {
            d.has.placeholder() &&
        ...
        createPlaceholder: function(e) {
          var t = d.get.icon(),
            n = d.get.url()
          d.generate.embed(n)
          ;(e = e || d.get.placeholder()), w.html(y.placeholder(e, t)), d.debug(
        ...
        createEmbed: function(t) {
          d.refresh(), (t = t || d.get.url()), (T = e('<div/>')
            .addClass(g.embed)
            .html(d.generate.embed(t))
            .appendTo(w)), f.onCreate.call(A, t), d.debug(
        ...
        change: function(e, t, n) {
          d.debug('Changing video to ', e, t, n), w
            .data(h.source, e)
            .data(h.id, t), n
            ? w.data(h.url, n)
            : w.removeData(h.url), d.has.embed() ? d.changeEmbed() : d.create()
        },
        reset: function() {
          d.debug(
            'Clearing embed and showing placeholder'
          ), d.remove.active(), d.remove.embed(), d.showPlaceholder(), f.onReset.call(
            A
          )
        },
        show: function() {
        ...
        showPlaceholder: function() {
          ...
          ), d.remove.active(), f.onPlaceholderDisplay.call(A)
        },
        get: {
          id: function() {
          ...
          icon: function() {
            return f.icon
              ? f.icon
              : void 0 !== w.data(h.icon) ? w.data(h.icon) : d.determine.icon()
          },
          source: function(e) {
            return f.source
              ? f.source
          ...
          url: function() {
            return f.url
              ? f.url
              : void 0 !== w.data(h.url) ? w.data(h.url) : d.determine.url()
          }
        },
        determine: {
          autoplay: function() {
          ...
          url: function() {
            ...
            return (e = void 0 !== v[n] && v[n].url.replace('{id}', t)), e &&
              w.data(h.url, e), e
          }
        },
        set: {
        ...
        performance: {
          ...
          display: function() {
            var t = f.name + ':',
              n = 0
            ;(r = !1), clearTimeout(d.performance.timer), e.each(s, function(
              e,
              t
            ) {
              n += t['Execution Time']
        ...
        invoke: function(t, n, o) {
          var a,
            ...
            s,
            l = R
          return (n = n || u), (o = A || o), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.modal = function(i) {
    var o,
      a = e(this),
      r = e(t),
      s = e(n),
      ...
      ;(k = {
        initialize: function() {
          k.verbose(
            'Initializing dimmer',
            D
          ), k.create.id(), k.create.dimmer(), k.refreshModals(), k.bind.events(), S.observeChanges &&
            k.observeChanges(), k.instantiate()
        },
        instantiate: function() {
        ...
        create: {
          dimmer: function() {
            ...
            k.debug('Creating dimmer'), (b = D.dimmer(n)), S.detachable
              ? (
                  k.verbose('Modal is detachable, moving content into dimmer'),
                  b.dimmer('add content', O)
                )
              : k.set.undetached(), (y = b.dimmer('get dimmer'))
          },
          id: function() {
            ;(C = (Math.random().toString(16) + '000000000').substr(2, 8)), (x =
              '.' + C), k.verbose('Creating unique id for element', C)
          }
        },
        destroy: function() {
          k.verbose('Destroying previous modal'), O.removeData(F).off(E), r.off(
            x
          ), y.off(x), q.off(E), D.dimmer('destroy')
        },
        observeChanges: function() {
          'MutationObserver' in t &&
            (
        ...
        attachEvents: function(t, n) {
          var i = e(t)
          ;(n = e.isFunction(k[n]) ? k[n] : k.toggle), i.length > 0
            ? (
        ...
        bind: {
          events: function() {
            k.verbose('Attaching events'), O.on(
              'click' + E,
              T.close,
              k.event.close
            )
              .on('click' + E, T.approve, k.event.approve)
              .on('click' + E, T.deny, k.event.deny), r.on(
              'resize' + x,
              k.event.resize
            )
          }
        ...
        event: {
          approve: function() {
            if (I || S.onApprove.call(j, e(this)) === !1)
        ...
        show: function(t) {
          ;(t = e.isFunction(t)
            ? t
            : function() {}), k.refreshModals(), k.set.dimmerSettings(), k.showModal(
            t
          )
        },
        hide: function(t) {
          ;(t = e.isFunction(t)
            ? t
            : function() {}), k.refreshModals(), k.hideModal(t)
        },
        showModal: function(t) {
          ;(t = e.isFunction(t) ? t : function() {}), k.is.animating() ||
          !k.is.active()
            ? (
                k.showDimmer(),
                k.cacheSizes(),
                      ...
                      O.transition('is supported')
                        ? (
                            ...
                            O.transition({
                              ...
                              useFailSafe: !0,
                              onComplete: function() {
                                S.onVisible.apply(j), S.keyboardShortcuts &&
                                  k.add.keyboardShortcuts(), k.save.focus(), k.set.active(), S.autofocus &&
                                  k.set.autofocus(), t()
                              }
                            })
                          )
              ...
              ? (
                  ...
                  O.transition({
                    ...
                    onStart: function() {
                      k.others.active() ||
                        n ||
                        k.hideDimmer(), S.keyboardShortcuts &&
        ...
        hideAll: function(t) {
          ...
          ;(t = e.isFunction(t) ? t : function() {}), n.length > 0 &&
            (
        ...
        hideOthers: function(t) {
          ...
          ;(t = e.isFunction(t) ? t : function() {}), n.length > 0 &&
            (k.debug('Hiding other modals', p), n.modal('hide modal', t, !0))
        },
        others: {
          active: function() {
        ...
        add: {
          keyboardShortcuts: function() {
            k.verbose('Adding keyboard shortcuts'), s.on(
              'keyup' + E,
              k.event.keyboard
            )
          }
        ...
        remove: {
          ...
          bodyStyle: function() {
            '' === l.attr('style') &&
              (k.verbose('Removing style attribute'), l.removeAttr('style'))
          },
        ...
        cacheSizes: function() {
          ...
          ;(void 0 !== k.cache && 0 === o) ||
            ...
            ), O.removeClass(A.loading), k.debug(
        ...
        set: {
          ...
          dimmerSettings: function() {
            ...
            S.inverted
              ...
              : y.removeClass(A.inverted), S.blurring
              ? b.addClass(A.blurring)
              : b.removeClass(A.blurring), D.dimmer('setting', n)
          },
          screenHeight: function() {
            k.can.fit()
              ? l.css('height', '')
          ...
          type: function() {
            k.can.fit()
              ...
              : (
                  k.verbose('Modal cannot fit on screen setting to scrolling'),
                  k.set.scrolling()
                )
          },
          position: function() {
            k.verbose('Centering modal on page', k.cache), k.can.fit()
        ...
        performance: {
          ...
          display: function() {
            var t = S.name + ':',
              n = 0
            ;(u = !1), clearTimeout(k.performance.timer), e.each(d, function(
              e,
              t
            ) {
              n += t['Execution Time']
        ...
        invoke: function(t, n, i) {
          var a,
            ...
            s,
            l = z
          return (n = n || g), (i = j || i), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.nag = function(n) {
    var i,
      o = e(this),
      a = o.selector || '',
      r = new Date().getTime(),
    ...
    return o.each(function() {
      ...
      ;(o = {
        initialize: function() {
          o.verbose('Initializing element'), h
            .on('click' + v, f.close, o.dismiss)
            .data(p, o), d.detachable &&
            h.parent()[0] !== b[0] &&
            h.detach().prependTo(b), d.displayTime > 0 &&
            setTimeout(o.hide, d.displayTime), o.show()
        },
        destroy: function() {
        ...
        hide: function() {
          o.debug('Showing nag', d.animation.hide), 'fade' == d.animation.show
            ? h.fadeIn(d.duration, d.easing)
            : h.slideUp(d.duration, d.easing)
        },
        onHide: function() {
          o.debug('Removing nag', d.animation.hide), h.remove(), d.onHide &&
            d.onHide()
        },
        dismiss: function(e) {
          d.storageMethod &&
            o.storage.set(
              d.key,
              d.value
            ), o.hide(), e.stopImmediatePropagation(), e.preventDefault()
        },
        should: {
          show: function() {
            return d.persist
        ...
        get: {
          storageOptions: function() {
            var e = {}
            return d.expires && (e.expires = d.expires), d.domain &&
              (e.domain = d.domain), d.path && (e.path = d.path), e
          }
        },
        clear: function() {
        ...
        storage: {
          set: function(n, i) {
            ...
            if ('localstorage' == d.storageMethod && void 0 !== t.localStorage)
              t.localStorage.setItem(n, i), o.debug(
              ...
              t.sessionStorage.setItem(n, i), o.debug(
          ...
          get: function(n, i) {
            var a
            return 'localstorage' == d.storageMethod &&
            void 0 !== t.localStorage
              ...
              : 'sessionstorage' == d.storageMethod &&
                ...
                : void 0 !== e.cookie
                  ? (a = e.cookie(n))
                  : o.error(m.noCookieStorage), ('undefined' != a &&
              'null' != a &&
              void 0 !== a &&
              null !== a) ||
              (a = void 0), a
        ...
        invoke: function(t, n, a) {
          var r,
            ...
            l,
            c = x
          return (n = n || u), (a = y || a), 'string' == typeof t &&
            void 0 !== c &&
            (
              (t = t.split(/[\. ]/)),
              (r = t.length - 1),
            ...
            ? (l = s.apply(a, n))
            : void 0 !== s && (l = s), e.isArray(i)
            ? i.push(l)
            : void 0 !== i ? (i = [i, l]) : void 0 !== l && (i = l), s
        }
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.popup = function(i) {
    var o,
      a = e(this),
      r = e(n),
      s = e(t),
      ...
      ;(y = {
        initialize: function() {
          y.debug(
            'Initializing',
            P
          ), y.createID(), y.bind.events(), !y.exists() &&
            x.preserve &&
            y.create(), x.observeChanges && y.observeChanges(), y.instantiate()
        },
        instantiate: function() {
        ...
        refresh: function() {
          x.popup
            ? (a = e(x.popup).eq(0))
            : x.inline &&
              ((a = D.nextAll(C.popup).eq(0)), (x.popup = a)), x.popup
            ? (
                ...
                x.movePopup &&
                  ...
                  (
                    y.debug('Moving popup to the same offset parent as target'),
                    a.detach().appendTo(v)
                  )
              )
            : (v = x.inline
                ? y.get.offsetParent(D)
                : y.has.popup() ? y.get.offsetParent(a) : l), v.is('html') &&
            v[0] !== l[0] &&
            (
        ...
        destroy: function() {
          y.debug('Destroying previous module'), p && p.disconnect(), a &&
            !x.preserve &&
            y.removePopup(), clearTimeout(y.hideTimer), clearTimeout(
            y.showTimer
          ), y.unbind.close(), y.unbind.events(), P.removeData(R)
        },
        event: {
          start: function(t) {
            var n = e.isPlainObject(x.delay) ? x.delay.show : x.delay
            clearTimeout(y.hideTimer), z ||
              (y.showTimer = setTimeout(y.show, n))
          },
          end: function() {
              ...
              t.removedNodes &&
                [].forEach.call(t.removedNodes, function(t) {
                  ;(t == I || e(t).find(I).length > 0) &&
                    (
                      y.debug('Element removed from DOM, tearing down events'),
                      y.destroy()
                    )
                })
            })
        ...
        createID: function() {
          ;(b = (Math.random().toString(16) + '000000000').substr(2, 8)), (h =
            '.' + b), y.verbose('Creating unique id for element', b)
        },
        toggle: function() {
          y.debug('Toggling pop-up'), y.is.hidden()
            ? (
        ...
        show: function(e) {
          if (
            ...
            if ((y.exists() || y.create(), x.onShow.call(a, I) === !1))
              return void y.debug(
                'onShow callback returned false, cancelling popup animation'
              )
            x.preserve || x.popup || y.refresh(), a &&
              y.set.position() &&
              (
                y.save.conditions(),
        ...
        hide: function(e) {
          if (((e = e || function() {}), y.is.visible() || y.is.animating())) {
            if (x.onHide.call(a, I) === !1)
              return void y.debug(
                'onHide callback returned false, cancelling popup animation'
              )
            y.remove.visible(), y.unbind.close(), y.restore.conditions(), y.animate.hide(
              e
            )
          }
        },
        ...
        exists: function() {
          return (
            !!a &&
            (x.inline || x.popup ? y.has.popup() : a.closest(E).length >= 1)
          )
        },
        ...
        save: {
          conditions: function() {
            ;(y.cache = { title: P.attr('title') }), y.cache.title &&
              P.removeAttr('title'), y.verbose(
        ...
        animate: {
          show: function(t) {
            ;(t = e.isFunction(t) ? t : function() {}), x.transition &&
            void 0 !== e.fn.transition &&
        ...
        get: {
          ...
          content: function() {
            return P.removeData(S.content), P.data(S.content) ||
              P.attr('title') ||
              x.content
          },
          variation: function() {
          ...
          calculations: function() {
            ...
            return (l = {
              ...
              : 0), (l.target.margin.left = x.inline
              ? y.is.rtl()
                ? parseInt(
                    t.getComputedStyle(n).getPropertyValue('margin-right'),
                    10
                  )
                : parseInt(
                    t.getComputedStyle(n).getPropertyValue('margin-left'),
                    10
                  )
              : 0), (e = l.screen), (l.boundary = {
          ...
          distanceFromBoundary: function(e, t) {
            var n,
              i,
              o = {}
            return (t = t || y.get.calculations()), (n = t.popup), (i =
              t.boundary), e &&
              (
                (o = {
                  top: e.top - i.top,
          ...
          offsetParent: function(t) {
            ...
            if (i)
              for (
                ...
                (i = i.parentNode), (o = e(i)), (a =
                  'none' === o.css('transform')), (r =
                  'static' === o.css('position')), (s = o.is('html'))
          ...
          nextPosition: function(e) {
            ...
            return j ||
              (
                ...
                (j = y.get.positions())
              ), y.debug('Recording last position tried', e), (j[
              e
            ] = !0), 'opposite' === x.prefer &&
              (
                (u = [o[n], i]),
              ...
              (y.debug('Using backup position', u), (u = r[e])), u
          }
        },
        set: {
          position: function(e, t) {
            ...
            if (
              ...
              if (
                ...
                return q++, (e = y.get.nextPosition(e)), y.debug(
                  'Trying new position',
                  e
              ...
              if (!x.lastResort)
                return y.debug(
                  ...
                  k.cannotPlace,
                  I
                ), y.remove.attempts(), y.remove.loading(), y.reset(), x.onUnplaceable.call(
                  a,
                  I
                ), !1
            ...
            return y.debug(
              'Position is on stage',
              e
            ), y.remove.attempts(), y.remove.loading(), x.setFluidWidth &&
              y.is.fluid() &&
              y.set.fluidWidth(t), !0
          },
          fluidWidth: function(e) {
            ;(e = e || y.get.calculations()), y.debug(
        ...
        bind: {
          events: function() {
            y.debug('Binding popup events to module'), 'click' == x.on &&
              P.on('click' + A, y.toggle), 'hover' == x.on &&
              P.on('touchstart' + A, y.event.touchstart), y.get.startEvent() &&
              P.on(y.get.startEvent() + A, y.event.start).on(
                y.get.endEvent() + A,
                y.event.end
              ), x.target && y.debug('Target set to element', D), s.on(
              'resize' + h,
              y.event.resize
            )
          },
          popup: function() {
            y.verbose('Allowing hover events on popup to prevent closing'), a &&
              y.has.popup() &&
              a
          ...
          close: function() {
            ;(x.hideOnScroll === !0 ||
              ...
              y.bind.closeOnScroll(), 'hover' == x.on &&
              z &&
              y.bind.touchClose(), 'click' == x.on &&
              x.closable &&
              y.bind.clickaway()
          },
          closeOnScroll: function() {
            y.verbose('Binding scroll close event to document'), F.one(
              y.get.scrollEvent() + h,
          ...
          clickaway: function() {
            y.verbose('Binding popup close event to document'), r.on(
              'click' + h,
              function(e) {
                y.verbose(
        ...
        performance: {
          ...
          display: function() {
            var t = x.name + ':',
              n = 0
            ;(u = !1), clearTimeout(y.performance.timer), e.each(d, function(
              e,
              t
            ) {
              n += t['Execution Time']
        ...
        invoke: function(t, n, i) {
          var a,
            ...
            s,
            l = M
          return (n = n || g), (i = I || i), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
      ...
      ;(d = {
        initialize: function() {
          d.debug(
            ...
            f
          ), d.set.duration(), d.set.transitionEvent(), d.read.metadata(), d.read.settings(), d.instantiate()
        },
        instantiate: function() {
          d.verbose('Storing instance of progress', d), (T = d), x.data(y, d)
        },
        destroy: function() {
          d.verbose('Destroying previous progress for', x), clearInterval(
            T.interval
          ), d.remove.state(), x.removeData(y), (T = void 0)
        },
        reset: function() {
        ...
        bind: {
          transitionEnd: function(e) {
            ...
            C.one(t + b, function(t) {
              ...
              C.triggerHandler(t)
            }, f.duration + f.failSafeDelay)), d.verbose(
        ...
        increment: function(e) {
          ...
          d.has.total()
            ...
            : (
              ...
              ), (n = d.get.normalizedValue(n)), d.set.progress(n)
        },
        ...
        remove: {
          progressPoll: function() {
            d.verbose('Removing progress poll timer'), d.progressPoll &&
          ...
          state: function() {
            d.verbose(
              'Removing stored state'
            ), delete d.total, delete d.percent, delete d.value
          },
          active: function() {
        ...
        set: {
          ...
          percent: function(e) {
            ;(e = 'string' == typeof e ? +e.replace('%', '') : e), (e =
              ...
              (
                ...
                f.limitValues &&
                  (d.value = d.value > 100 ? 100 : d.value < 0 ? 0 : d.value)
              ), d.set.barWidth(
              e
            ), d.set.labelInterval(), d.set.labels(), f.onChange.call(
              S,
              e,
              d.value,
              d.total
          ...
          labelInterval: function() {
            var t = function() {
              ...
              ), clearInterval(d.interval), (A = !1), d.set.labels()
            }
            clearInterval(d.interval), d.bind.transitionEnd(
              t
          ...
          active: function(e) {
            ;(e = e || f.text.active), d.debug(
              'Setting active state'
            ), f.showActivity &&
              !d.is.active() &&
              x.addClass(
                m.active
              ), d.remove.warning(), d.remove.error(), d.remove.success(), (e = f.onLabelUpdate(
              'active',
              e,
              d.value,
              d.total
            )), e && d.set.label(e), d.bind.transitionEnd(function() {
              f.onActive.call(S, d.value, d.total)
            })
          },
          success: function(e) {
            ;(e = e || f.text.success || f.text.active), d.debug(
              'Setting success state'
            ), x.addClass(
              m.success
            ), d.remove.active(), d.remove.warning(), d.remove.error(), d.complete(), f
              .text.success
              ? (
          ...
          warning: function(e) {
            ;(e = e || f.text.warning), d.debug(
              'Setting warning state'
            ), x.addClass(
              m.warning
            ), d.remove.active(), d.remove.success(), d.remove.error(), d.complete(), (e = f.onLabelUpdate(
              'warning',
              e,
              d.value,
              d.total
          ...
          error: function(e) {
            ;(e = e || f.text.error), d.debug(
              'Setting error state'
            ), x.addClass(
              m.error
            ), d.remove.active(), d.remove.success(), d.remove.warning(), d.complete(), (e = f.onLabelUpdate(
              'error',
              e,
              d.value,
              d.total
        ...
        update: {
          ...
          progress: function(e) {
            var t
            ;(e = d.get.numericValue(e)), e === !1 &&
              d.error(h.nonNumeric, e), (e = d.get.normalizedValue(
              e
            )), d.has.total()
              ? (
                  d.set.value(e),
        ...
        invoke: function(t, n, o) {
          var a,
            ...
            s,
            l = T
          return (n = n || u), (o = S || o), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.rating = function(t) {
    var n,
      i = e(this),
      o = i.selector || '',
      a = new Date().getTime(),
    ...
    return i.each(function() {
      ...
      ;(d = {
        initialize: function() {
          d.verbose('Initializing rating module', f), 0 === w.length &&
            d.setup.layout(), f.interactive
            ? d.enable()
            : d.disable(), d.set.initialLoad(), d.set.rating(
            d.get.initialRating()
          ), d.remove.initialLoad(), d.instantiate()
        },
        instantiate: function() {
        ...
        destroy: function() {
          d.verbose(
            ...
            x
          ), d.remove.events(), C.removeData(b)
        },
        refresh: function() {
          w = C.find(p.icon)
        },
        ...
        event: {
          mouseenter: function() {
            var t = e(this)
            t.nextAll().removeClass(g.selected), C.addClass(
              g.selected
          ...
          click: function() {
            var t = e(this),
              n = d.get.rating(),
              i = w.index(t) + 1
            ;('auto' == f.clearable ? 1 === w.length : f.clearable) && n == i
              ? d.clearRating()
              : d.set.rating(i)
          }
        },
        ...
        enable: function() {
          d.debug(
            'Setting rating to interactive mode'
          ), d.bind.events(), C.removeClass(g.disabled)
        },
        disable: function() {
          d.debug(
            'Setting rating to read-only mode'
          ), d.remove.events(), C.addClass(g.disabled)
        },
        is: {
          initialLoad: function() {
            return u
        ...
        set: {
          rating: function(e) {
            var t = e - 1 >= 0 ? e - 1 : 0,
              n = w.eq(t)
            C.removeClass(g.selected), w
              .removeClass(g.selected)
              .removeClass(g.active), e > 0 &&
              (
        ...
        performance: {
          ...
          display: function() {
            ...
            ;(a = !1), clearTimeout(d.performance.timer), e.each(r, function(
              ...
              n += t['Execution Time']
            }), (t += ' ' + n + 'ms'), o && (t += " '" + o + "'"), i.length >
              1 && (t += ' (' + i.length + ')'), (void 0 !== console.group ||
              void 0 !== console.table) &&
              r.length > 0 &&
              (
                console.groupCollapsed(t),
        ...
        invoke: function(t, i, o) {
          var a,
            ...
            s,
            l = x
          return (i = i || c), (o = y || o), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
            ...
            ? (s = r.apply(o, i))
            : void 0 !== r && (s = r), e.isArray(n)
            ? n.push(s)
            : void 0 !== n ? (n = [n, s]) : void 0 !== s && (n = s), r
        }
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.search = function(i) {
    var o,
      a = e(this),
      r = a.selector || '',
      s = new Date().getTime(),
    ...
    return e(this).each(function() {
      ...
      ;(f = {
        initialize: function() {
          f.verbose(
            'Initializing module'
          ), f.determine.searchFields(), f.bind.events(), f.set.type(), f.create.results(), f.instantiate()
        },
        instantiate: function() {
        ...
        refresh: function() {
          f.debug('Refreshing selector cache'), (S = k.find(
            b.prompt
          )), (T = k.find(b.searchButton)), (P = k.find(
            b.category
        ...
        bind: {
          events: function() {
            f.verbose('Binding events to search'), m.automatic &&
              (
        ...
        event: {
          ...
          blur: function(e) {
            var t = n.activeElement === this,
              i = function() {
                f.cancel.query(), f.remove.focus(), (f.timer = setTimeout(
                  f.hideResults,
                  m.hideDelay
                ))
              }
          ...
          result: {
            ...
            click: function(n) {
              ...
              if (e.isFunction(m.onSelect) && m.onSelect.call(E, u, c) === !1)
                return f.debug(
                  'Custom onSelect callback cancelled default select action'
                ), void (O = !0)
              f.hideResults(), l && f.set.value(l), r &&
                (
          ...
          if (
            ...
            if (l == c.enter) {
              if (
                ...
                return f.event.result.click.call(
                  n.filter('.' + g.active),
                  e
                ), e.preventDefault(), !1
            } else
        ...
        setup: {
          api: function(t, n) {
            ...
            e.extend(!0, i, m.apiSettings), f.verbose(
        ...
        get: {
          ...
          result: function(t, n) {
            var i = ['title', 'id'],
              o = !1
            return (t = void 0 !== t ? t : f.get.value()), (n =
              void 0 !== n ? n : f.get.results()), 'category' === m.type
              ? (
        ...
        query: function(t) {
          ...
          var n = f.get.value(),
            i = f.read.cache(n)
          ;(t = t || function() {}), f.has.minimumCharacters()
            ? (
                i
                  ? (
        ...
        search: {
          local: function(e) {
            ...
            f.set.loading(), f.save.results(n), f.debug(
              'Returned local search results',
              n
            ), (t = f.generateResults({
              results: n
            })), f.remove.loading(), f.addResults(t), f.inject.id(
              n
            ), f.write.cache(e, { html: t, results: n })
          },
          remote: function(t, n) {
            ;(n = e.isFunction(n) ? n : function() {}), k.api('is loading') &&
              k.api('abort'), f.setup.api(t, n), k.api('query')
          },
          object: function(t, n, i) {
            ...
            return (n = n || m.source), (i =
              void 0 !== i ? i : m.searchFields), e.isArray(i) ||
              (i = [i]), void 0 === n || n === !1
              ? (f.error(y.source), [])
              : (
        ...
        parse: {
          response: function(e, t) {
            ...
            f.verbose('Parsing server response', e), void 0 !== e &&
              void 0 !== t &&
              void 0 !== e[h.results] &&
              (
                f.addResults(n),
        ...
        create: {
          id: function(e, t) {
            ...
            return void 0 !== t
              ...
              : ((i = o), f.verbose('Creating result id', i)), i
          },
          results: function() {
            ...
            return 'category' === m.type
              ? e.each(t, function(t, o) {
                  ;(i = 0), e.each(o.results, function(e, t) {
                    var a = o.results[e]
                    void 0 === a.id &&
                      (a.id = f.create.id(i, n)), f.inject.result(a, i, n), i++
                  }), n++
                })
              : e.each(t, function(e, n) {
                  var o = t[e]
                  void 0 === o.id &&
                    (o.id = f.create.id(i)), f.inject.result(o, i), i++
                }), t
          }
        },
        save: {
          results: function(e) {
            f.verbose('Saving current search results to metadata', e), k.data(
              v.results,
              e
            )
          }
        ...
        addResults: function(t) {
          if (e.isFunction(m.onResultsAdd) && m.onResultsAdd.call(A, t) === !1)
        ...
        hideResults: function(t) {
          ;(t = e.isFunction(t) ? t : function() {}), f.is.visible() &&
            (
              f.can.transition()
                ? (
        ...
        generateResults: function(t) {
          ...
          return i || o
            ...
            : m.showNoResults &&
              (a = f.displayMessage(y.noResults, 'empty')), m.onResults.call(
            E,
            t
          ), a
        },
        displayMessage: function(e, t) {
          return (t = t || 'standard'), f.debug(
            'Displaying message',
            e,
            t
          ), f.addResults(m.templates.message(e, t)), m.templates.message(e, t)
        },
        setting: function(t, n) {
        ...
        performance: {
          ...
          display: function() {
            ...
            ;(s = !1), clearTimeout(f.performance.timer), e.each(l, function(
              ...
              n += t['Execution Time']
            }), (t += ' ' + n + 'ms'), r && (t += " '" + r + "'"), a.length >
              1 && (t += ' (' + a.length + ')'), (void 0 !== console.group ||
              void 0 !== console.table) &&
              l.length > 0 &&
              (
                console.groupCollapsed(t),
        ...
        invoke: function(t, n, i) {
          var a,
            ...
            s,
            l = F
          return (n = n || d), (i = E || i), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
                ...
                (
                  ...
                  e.each(o.results, function(e, t) {
                    t[n.url]
                      ...
                      : (i +=
                          '<a class="result">'), void 0 !== t[n.image] && (i += '<div class="image"> <img src="' + t[n.image] + '"></div>'), (i += '<div class="content">'), void 0 !== t[n.price] && (i += '<div class="price">' + t[n.price] + '</div>'), void 0 !== t[n.title] && (i += '<div class="title">' + t[n.title] + '</div>'), void 0 !== t[n.description] && (i += '<div class="description">' + t[n.description] + '</div>'), (i += '</div>'), (i += '</a>')
                  }),
                  (i += '</div>')
                )
            }),
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.shape = function(i) {
    var o,
      a = e(this),
      ...
      ;(m = {
        initialize: function() {
          m.verbose(
            ...
            A
          ), m.set.defaultSide(), m.instantiate()
        },
        instantiate: function() {
        ...
        refresh: function() {
          m.verbose('Refreshing selector cache for', A), (w = e(A)), (k = e(
            this
          ).find(h.shape)), (S = e(this).find(h.side))
        },
        repaint: function() {
        ...
        animate: function(e, n) {
          m.verbose('Animating box with properties', e), (n =
            n ||
            function(e) {
              m.verbose('Executing animation callback'), void 0 !== e &&
                e.stopPropagation(), m.reset(), m.set.active()
            }), v.beforeChange.call(f[0]), m.get.transitionEvent()
            ? (
        ...
        reset: function() {
          m.verbose('Animating states reset'), w
            .removeClass(y.animating)
            .attr('style', '')
            .removeAttr('style'), k
            .attr('style', '')
            .removeAttr('style'), S.attr('style', '')
            .removeAttr('style')
            .removeClass(y.hidden), f
            .removeClass(y.animating)
            .attr('style', '')
            .removeAttr('style')
        },
        ...
        set: {
          defaultSide: function() {
            ;(t = w.find('.' + v.className.active)), (f =
              t.next(h.side).length > 0
                ? t.next(h.side)
                : w.find(h.side).first()), (T = !1), m.verbose(
              'Active side set to',
              t
          ...
          duration: function(e) {
            ;(e = e || v.duration), (e =
              'number' == typeof e ? e + 'ms' : e), m.verbose(
          ...
          stageSize: function() {
            ...
            t.removeClass(y.active), n.addClass(y.active), e.insertAfter(
              w
            ), e.remove(), 'auto' != v.width &&
              (
          ...
          nextSide: function(e) {
            ;(T = e), (f = S.filter(e)), (T = S.index(f)), 0 === f.length &&
              (m.set.defaultSide(), m.error(b.side)), m.verbose(
              'Next side manually set to',
              f
            )
          },
          active: function() {
            m.verbose('Setting new side to active', f), S.removeClass(
              y.active
            ), f.addClass(y.active), v.onChange.call(f[0]), m.set.defaultSide()
          }
        },
        flip: {
          up: function() {
        ...
        stage: {
          ...
          behind: function() {
            ...
            m.verbose(
              ...
              f,
              n
            ), t.css({ transform: 'rotateY(0deg)' }), f
        ...
        performance: {
          ...
          display: function() {
            var t = v.name + ':',
              n = 0
            ;(r = !1), clearTimeout(m.performance.timer), e.each(s, function(
              e,
              t
            ) {
              n += t['Execution Time']
            }), (t += ' ' + n + 'ms'), g && (t += " '" + g + "'"), a.length >
              1 && (t += ' (' + a.length + ')'), (void 0 !== console.group ||
              void 0 !== console.table) &&
              s.length > 0 &&
              (
        ...
        invoke: function(t, n, i) {
          var a,
            ...
            s,
            l = R
          return (n = n || u), (i = A || i), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.sidebar = function(i) {
    var o,
      a = e(this),
      r = e(t),
      s = e(n),
      ...
      ;(C = {
        initialize: function() {
          C.debug(
            ...
            i
          ), C.create.id(), (x = C.get.transitionEvent()), w.delaySetup
            ? p(C.setup.layout)
            : C.setup.layout(), p(function() {
            C.setup.cache()
          }), C.instantiate()
        },
        instantiate: function() {
        ...
        create: {
          id: function() {
            ;(b = (Math.random().toString(16) + '000000000').substr(2, 8)), (h =
              '.' + b), C.verbose('Creating unique id for element', b)
          }
        },
        destroy: function() {
          C.verbose('Destroying previous module for', F), F.off(P).removeData(
            E
          ), C.is.ios() && C.remove.ios(), O.off(h), r.off(h), s.off(h)
        },
        event: {
          clickaway: function(e) {
            var t = j.find(e.target).length > 0 || j.is(e.target),
              n = O.is(e.target)
            t && (C.verbose('User clicked on dimmed page'), C.hide()), n &&
              (
          ...
          containScroll: function(e) {
            z.scrollTop <= 0 && (z.scrollTop = 1), z.scrollTop +
              z.offsetHeight >=
              z.scrollHeight &&
        ...
        bind: {
          clickaway: function() {
            C.verbose('Adding clickaway events to context', O), w.closable &&
          ...
          scrollLock: function() {
            w.scrollLock &&
              ...
              ), C.verbose('Adding events to contain sidebar scroll'), s.on(
              'touchmove' + h,
              C.event.touch
        ...
        unbind: {
          ...
          scrollLock: function() {
            C.verbose('Removing scroll lock from page'), s.off(h), r.off(
              h
            ), F.off('scroll' + P)
          }
        },
        add: {
          inlineCSS: function() {
            ...
            o &&
              ...
              ), (t += '</style>'), (a = e(t).appendTo(c)), C.debug(
              'Adding sizing css to head',
              a
            )
          }
        },
        refresh: function() {
          C.verbose('Refreshing selector cache'), (O = e(
            w.context
          )), (D = O.children(k.sidebar)), (j = O.children(
            k.pusher
          )), (q = O.children(k.fixed)), C.clear.cache()
        },
          ...
          layout: function() {
            0 === O.children(k.pusher).length &&
              ...
              (
                ...
                C.refresh()
              ), C.clear.cache(), C.set.pushable(), C.set.direction()
          }
        },
        attachEvents: function(t, n) {
          var i = e(t)
          ;(n = e.isFunction(C[n]) ? C[n] : C.toggle), i.length > 0
            ? (
        ...
        hide: function(t) {
          ;(t = e.isFunction(t) ? t : function() {}), (C.is.visible() ||
            C.is.animating()) &&
            (
        ...
        toggle: function() {
          C.verbose('Determining toggled direction'), C.is.hidden()
            ? C.show()
            : C.hide()
        },
        pushPage: function(t) {
          ...
          ;(t = e.isFunction(t) ? t : function() {}), 'scale down' ==
            w.transition && C.scrollToTop(), C.set.transition(
            a
          ), C.repaint(), (n = function() {
          ...
          }), r.off(x + h), r.on(x + h, o), p(n), w.dimPage &&
            !C.othersVisible() &&
            p(i)
        },
        pullPage: function(t) {
          ...
          ;(t = e.isFunction(t) ? t : function() {}), C.verbose(
            'Removing context push state',
            C.get.direction()
          ), C.unbind.clickaway(), C.unbind.scrollLock(), (n = function() {
            C.set.transition(
              o
            ), C.set.animating(), C.remove.visible(), w.dimPage &&
              !C.othersVisible() &&
            ...
            e.target == a[0] &&
              (
                ...
                C.remove.transition(),
                C.remove.inlineCSS(),
                ('scale down' == o || (w.returnScroll && C.is.mobile())) &&
                  C.scrollBack(),
                t.call(z)
              )
        ...
        scrollToTop: function() {
          ...
          ), (y = e(t).scrollTop()), F.scrollTop(0), t.scrollTo(0, 0)
        },
        scrollBack: function() {
          C.verbose('Scrolling back to original page position'), t.scrollTo(
            0,
            y
          )
        },
        ...
        remove: {
          inlineCSS: function() {
            C.debug('Removing inline css styles', a), a &&
              a.length > 0 &&
              a.remove()
          },
          ios: function() {
        ...
        is: {
          ...
          ios: function() {
            ...
            return (
              !(!t || n) && (C.verbose('Browser was found to be iOS', e), !0)
            )
          },
          mobile: function() {
            var e = navigator.userAgent
          ...
          rtl: function() {
            return void 0 === C.cache.rtl &&
              (C.cache.rtl = 'rtl' == F.css('direction')), C.cache.rtl
          }
        },
        setting: function(t, n) {
        ...
        performance: {
          ...
          display: function() {
            var t = w.name + ':',
              n = 0
            ;(d = !1), clearTimeout(C.performance.timer), e.each(f, function(
              e,
              t
            ) {
              n += t['Execution Time']
        ...
        invoke: function(t, n, i) {
          var a,
            ...
            s,
            l = I
          return (n = n || v), (i = z || i), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.sticky = function(i) {
    var o,
      a = e(this),
      r = a.selector || '',
      s = new Date().getTime(),
    ...
    return a.each(function() {
      ...
      ;(v = {
        initialize: function() {
          v.determineContainer(), v.determineContext(), v.verbose(
            'Initializing sticky',
            p,
            a
          ), v.save.positions(), v.checkErrors(), v.bind.events(), p.observeChanges &&
            v.observeChanges(), v.instantiate()
        },
        instantiate: function() {
          v.verbose('Storing instance of module', v), (T = v), w.data(C, v)
        },
        destroy: function() {
          v.verbose('Destroying previous instance'), v.reset(), m &&
            m.disconnect(), g && g.disconnect(), k
            .off('load' + x, v.event.load)
            .off('resize' + x, v.event.resize), S.off(
            'scrollchange' + x,
        ...
        bind: {
          events: function() {
            k
              ...
              .on('resize' + x, v.event.resize), S.off('scroll' + x)
        ...
        refresh: function(e) {
          v.reset(), p.context || v.determineContext(), e &&
            v.determineContainer(), v.save.positions(), v.stick(), p.onReposition.call(
            R
          )
        },
        supports: {
        ...
        save: {
          ...
          positions: function() {
            ...
            }), v.set.containerSize(), v.stick(), v.debug(
        ...
        get: {
          direction: function(e) {
            var t = 'down'
            return (e = e || S.scrollTop()), void 0 !== v.lastScroll &&
              (v.lastScroll < e
                ? (t = 'down')
                : v.lastScroll > e && (t = 'up')), t
          },
        ...
        set: {
          offset: function() {
            v.verbose('Setting offset on element', p.offset), w.css(
              'margin-top',
              p.offset
            )
          },
          ...
          scroll: function(e) {
            v.debug('Setting scroll on element', e), v.elementScroll != e &&
              (
        ...
        stick: function(e) {
          ...
          0 !== a.height &&
            ...
            (v.is.initialPosition()
              ? e.top >= s.bottom
                ? (
                    v.debug('Initial element position is bottom of container'),
                    v.bindBottom()
                  )
                : e.top > a.top &&
        ...
        fixTop: function() {
          v.debug('Fixing element to top of page'), p.setSize &&
            v.set.size(), v.set.minimumSize(), v.set.offset(), w
        ...
        fixBottom: function() {
          v.debug('Sticking element to bottom of page'), p.setSize &&
            v.set.size(), v.set.minimumSize(), v.set.offset(), w
            .css({ left: v.cache.element.left, bottom: '', marginBottom: '' })
            .removeClass(h.bound)
            .removeClass(h.top)
        ...
        reset: function() {
          v.debug(
            'Resetting elements position'
          ), v.unbind(), v.unfix(), v.resetCSS(), v.remove.offset(), v.remove.lastScroll()
        },
        resetCSS: function() {
        ...
        performance: {
          ...
          display: function() {
            var t = p.name + ':',
              n = 0
            ;(s = !1), clearTimeout(v.performance.timer), e.each(l, function(
              e,
              t
            ) {
              n += t['Execution Time']
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.tab = function(i) {
    var o,
    ...
    return a.each(function() {
      ...
      ;(h = {
        initialize: function() {
          h.debug(
            'Initializing tab menu item',
            A
          ), h.fix.callbacks(), h.determineTabs(), h.debug(
            'Determining tabs',
            y.context,
            g
          ), y.auto && h.set.auto(), h.bind.events(), y.history &&
            !f &&
            (h.initializeHistory(), (f = !0)), h.instantiate()
        },
        instantiate: function() {
        ...
        initializeHistory: function() {
          ...
          if ('state' == y.historyType) {
            if ((h.debug('Using HTML5 to manage state'), y.path === !1))
        ...
        event: {
          ...
          history: {
            change: function(t) {
              ...
              h.performance.display(), h.debug(
                'History change event',
                n,
                t
              ), (b = t), void 0 !== n && h.changeTab(n), i &&
                e.address.title(i)
            }
          }
        },
        ...
        cache: {
          ...
          remove: function(e) {
            ;(e = e || v), h.debug('Removing cached content for', e), delete R[
              e
            ]
          }
        },
            ...
            if ((h.verbose('Looking for tab', i), g)) {
              if (
                ...
                return o
                  ...
                  : (h.activate.navigation(f), h.fetch.content(f, n)), !1
              h.debug('Opened local tab', f), h.activate.all(f), h.cache.read(
                f
              ) ||
                (
                  h.cache.add(f, !0),
              ...
              if (
                ...
                return h.debug(
                  ...
                  setTimeout(function() {
                    h.scrollTo(s)
                  }, 0), h.activate.all(f), h.cache.read(f) ||
                  (
                    h.cache.add(f, !0),
                    h.debug('First time tab loaded calling tab init'),
                    y.onFirstLoad.call(S[0], f, p, b)
                  ), y.onLoad.call(S[0], f, p, b), !1
            }
          })
        },
        scrollTo: function(t) {
        ...
        update: {
          content: function(t, n, i) {
            var o = h.get.tabElement(t),
              a = o[0]
            ;(i = void 0 !== i ? i : y.evaluateScripts), 'string' ==
              typeof y.cacheType &&
          ...
          content: function(t, n) {
            var i,
              ...
              r = {
                ...
                headers: { 'X-Remote': !0 },
                onSuccess: function(e) {
                  'response' == y.cacheType &&
                    h.cache.add(n, e), h.update.content(t, e), t == v
                    ? (h.debug('Content loaded', t), h.activate.tab(t))
                    : h.debug(
                        'Content loaded in background',
                        t
                      ), y.onFirstLoad.call(a[0], t, p, b), y.onLoad.call(
                    a[0],
                    t,
                    p,
                    b
              ...
              l = s && 'pending' === s.state()
            ;(n = n || t), (o = h.cache.read(n)), y.cache && o
              ? (
                  h.activate.tab(t),
        ...
        activate: {
          ...
          tab: function(e) {
            ...
            h.verbose('Showing tab content for', t), i ||
              (
                t.addClass(x.active),
          ...
          navigation: function(e) {
            var t = h.get.navElement(e),
              ...
              i = t.hasClass(x.active)
            h.verbose('Activating tab navigation for', t, e), i ||
              (t.addClass(x.active), n.removeClass(x.active + ' ' + x.loading))
          }
        },
        deactivate: {
          all: function() {
        ...
        get: {
          ...
          tabElement: function(e) {
            var t, n, i, o
            return (e = e || v), (i = h.utilities.pathToArray(
              e
            )), (o = h.utilities.last(i)), (t = g.filter(
              '[data-' + C.tab + '="' + e + '"]'
            )), (n = g.filter('[data-' + C.tab + '="' + o + '"]')), t.length > 0
              ? t
              : n
          },
          tab: function() {
        ...
        utilities: {
          ...
          pathToArray: function(e) {
            return void 0 === e && (e = v), 'string' == typeof e
              ? e.split('/')
              : [e]
          },
        ...
        performance: {
          ...
          display: function() {
            var t = y.name + ':',
              n = 0
            ;(s = !1), clearTimeout(h.performance.timer), e.each(l, function(
              e,
              t
            ) {
              n += t['Execution Time']
        ...
        invoke: function(t, n, i) {
          var a,
            ...
            s,
            l = O
          return (n = n || d), (i = F || i), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.transition = function() {
    var i,
      o = e(this),
      a = o.selector || '',
      r = new Date().getTime(),
    ...
    return o.each(function(t) {
      ...
      ;(x = {
        initialize: function() {
          ;(f = x.get.settings.apply(w, l)), (v = f.className), (g =
            f.error), (p = f.metadata), (y = '.' + f.namespace), (b =
            'module-' + f.namespace), (m =
            C.data(b) || x), (h = x.get.animationEndEvent()), d &&
            (d = x.invoke(c)), d === !1 &&
            (
        ...
        delay: function(e) {
          ...
          a || (a = x.can.transition() ? x.get.direction() : 'static'), (e =
            void 0 !== e ? e : f.interval), (n =
            'auto' == f.reverse && a == v.outward), (i =
            n || 1 == f.reverse
              ? (o.length - t) * f.interval
              : t * f.interval), x.debug(
        ...
        reset: function() {
          ...
          ), x.remove.animationCallbacks(), x.restore.conditions(), x.remove.animating()
        },
        queue: function(e) {
          x.debug('Queueing animation of', e), (x.queuing = !0), C.one(
            h + '.queue' + y,
            function() {
        ...
        complete: function(e) {
          x.debug(
            'Animation complete',
            f.animation
          ), x.remove.completeCallback(), x.remove.failSafe(), x.is.looping() ||
            (x.is.outward()
              ? (
        ...
        force: {
          visible: function() {
            ...
            o !== n
              ? (
                  x.verbose('Overriding default display to show element', n),
                  C.attr('style', i)
                )
        ...
        has: {
          direction: function(t) {
            var n = !1
            return (t = t || f.animation), 'string' == typeof t &&
              (
                (t = t.split(' ')),
                e.each(t, function(e, t) {
        ...
        set: {
          animating: function(e) {
            var t
            x.remove.completeCallback(), (e =
              e || f.animation), (t = x.get.animationClass(
              e
            )), x.save.animation(
              t
            ), x.force.visible(), x.remove.hidden(), x.remove.direction(), x.start.animation(
              t
            )
          },
          ...
          direction: function(e) {
            ;(e = e || x.get.direction()), e == v.inward
              ? x.set.inward()
              : x.set.outward()
          },
          looping: function() {
          ...
          inward: function() {
            x.debug('Setting direction to inward'), C.removeClass(
              v.outward
            ).addClass(v.inward)
          },
          outward: function() {
            x.debug('Setting direction to outward'), C.removeClass(
              v.inward
            ).addClass(v.outward)
          },
          visible: function() {
        ...
        start: {
          animation: function(e) {
            ;(e = e || x.get.animationClass()), x.debug(
              'Starting tween',
              e
            ), C.addClass(e).one(
              h + '.complete' + y,
              x.complete
            ), f.useFailSafe && x.add.failSafe(), x.set.duration(
              f.duration
            ), f.onStart.call(w)
          }
        },
        save: {
          ...
          transitionExists: function(t, n) {
            ;(e.fn.transition.exists[t] = n), x.verbose(
        ...
        remove: {
          ...
          failSafe: function() {
            x.verbose('Removing fail safe timer', x.timer), x.timer &&
          ...
          looping: function() {
            x.debug('Transitions are no longer looping'), x.is.looping() &&
              (x.reset(), C.removeClass(v.looping))
          },
          transition: function() {
        ...
        get: {
          ...
          currentAnimation: function() {
            return (
              !(!x.cache || void 0 === x.cache.animation) && x.cache.animation
            )
          },
          ...
          duration: function(e) {
            return (e = e || f.duration), e === !1 &&
              (e = C.css('animation-duration') || 0), 'string' == typeof e
              ? e.indexOf('ms') > -1 ? parseFloat(e) : 1e3 * parseFloat(e)
              : e
          },
          displayType: function(e) {
            return (e = void 0 === e || e), f.displayType
              ? f.displayType
              : (
                  e && void 0 === C.data(p.displayType) && x.can.transition(!0),
                  C.data(p.displayType)
                )
          },
          userStyle: function(e) {
            return (e = e || C.attr('style') || ''), e.replace(
              /display.*?;/,
              ''
            )
          },
        ...
        is: {
          ...
          occurring: function(e) {
            return (e = e || f.animation), (e =
              '.' + e.replace(' ', '.')), C.filter(e).length > 0
          },
          visible: function() {
            return C.is(':visible')
          },
        ...
        hide: function() {
          x.verbose('Hiding element'), x.is.animating() &&
            x.reset(), w.blur(), x.remove.display(), x.remove.visible(), x.set.hidden(), x.force.hidden(), f.onHide.call(
            w
          ), f.onComplete.call(w)
        },
        show: function(e) {
          x.verbose(
            'Showing element',
            e
          ), x.remove.hidden(), x.set.visible(), x.force.visible(), f.onShow.call(
            w
          ), f.onComplete.call(w)
        },
        toggle: function() {
        ...
        stopAll: function() {
          x.debug(
            'Stopping all animation'
          ), x.remove.queueCallback(), C.triggerHandler(h)
        },
        clear: {
          queue: function() {
        ...
        performance: {
          ...
          display: function() {
            var t = f.name + ':',
              n = 0
            ;(r = !1), clearTimeout(x.performance.timer), e.each(s, function(
              e,
              t
            ) {
              n += t['Execution Time']
        ...
        invoke: function(t, n, o) {
          var a,
            ...
            s,
            l = m
          return (n = n || u), (o = w || o), 'string' == typeof t &&
            void 0 !== l &&
            (
              (t = t.split(/[\. ]/)),
              (a = t.length - 1),
            ...
            : void 0 !== r && (s = r), e.isArray(i)
            ? i.push(s)
            : void 0 !== i ? (i = [i, s]) : void 0 !== s && (i = s), void 0 !==
            r && r
        }
      }), x.initialize()
    }), void 0 !== i ? i : this
    ...
    return o.each(function() {
      ...
      ;(g = {
        ...
        query: function() {
          ...
          if (
            ((g.cancelled = !1), !(f = g.get.templatedURL()) && !g.is.mocked())
          )
          ...
          if ((f = g.add.urlData(f)) || g.is.mocked()) {
            if (
              ...
              ), (g.request = g.create.request()), void g.request.resolveWith(
                R,
              ...
              ? v.throttleFirstRequest || g.timer
                ? (
                    ...
                    (g.timer = setTimeout(function() {
                      g.timer &&
                        delete g.timer, g.debug('Sending throttled request', void 0, o.method), g.send.request()
                    }, v.throttle))
                  )
                : (
        ...
        should: {
          removeError: function() {
            return (
              v.hideError === !0 || ('auto' === v.hideError && !g.is.form())
            )
          }
        },
        is: {
        ...
        add: {
                ...
                i &&
                  (
                    ...
                    e.each(i, function(i, o) {
                      ...
                      if (void 0 === r)
                        return g.error(y.requiredParameter, a, t), (t = !1), !1
                      g.verbose(
                        'Found required variable',
                        a,
                        r
                      ), (r = v.encodeParameters ? g.get.urlEncodedValue(r) : r), (t = t.replace(o, r))
                    })
                  ),
                o &&
                  (
          ...
          formData: function(t) {
            ...
            return (t = t || v.data), (n = e.isPlainObject(t)), n
              ? i
                ? (
              ...
              : (g.debug('Adding form data', o), (t = o)), t
          }
        },
        send: {
          request: function() {
            g.set.loading(), (g.request = g.create.request()), g.is.mocked()
              ? (g.mockedXHR = g.create.mockedXHR())
              : (g.xhr = g.create.xhr()), v.onRequest.call(R, g.request, g.xhr)
          }
        },
        event: {
          trigger: function(e) {
            g.query(), ('submit' != e.type && 'click' != e.type) ||
              e.preventDefault()
          },
          xhr: {
            always: function() {},
          ...
          request: {
              ...
              g.debug('Successful API Response', e), 'local' === v.cache &&
                f &&
                (
            ...
            complete: function(e, t) {
              ...
              g.was.succesful()
                ...
                : (
                  ...
                  ), g.remove.loading(), v.onComplete.call(R, i, k, n)
            },
            fail: function(e, t, n) {
              ...
              'invalid' == t
                ...
                ), g.debug('API Request failed', a, e), v.onFailure.call(
                R,
                i,
                k,
                e
        ...
        create: {
          ...
          mockedXHR: function() {
            ...
            return (i = e
              ...
              : e.isFunction(a) &&
                (
                  (t = function(e) {
                    g.debug('Async callback returned response', e), e
          ...
          xhr: function() {
            ...
            return (t = e
              ...
              .done(g.event.xhr.done)
              .fail(g.event.xhr.fail)), g.verbose(
        ...
        set: {
          ...
          loading: function() {
            g.verbose('Adding loading state to element', T), T.addClass(
              x.loading
            ), (m = new Date().getTime())
          }
        },
        remove: {
          error: function() {
            g.verbose('Removing error state from element', T), T.removeClass(
              x.error
            )
          },
          loading: function() {
            g.verbose('Removing loading state from element', T), T.removeClass(
              x.loading
            )
          }
        },
        get: {
          ...
          settings: function() {
            var t
            return (t = v.beforeSend.call(R, v)), t &&
              (
                void 0 !== t.success &&
                  (
              ...
              ), void 0 === t && g.error(y.noReturnedValue), t === !1
              ? t
            ...
            return e.isWindow(A) || 'now' == v.on
              ...
              : 'auto' == v.on
                ? k.is('input')
                  ? void 0 !== A.oninput
                    ? 'input'
                    : void 0 !== A.onpropertychange ? 'propertychange' : 'keyup'
        ...
        performance: {
          ...
          display: function() {
            var t = v.name + ':',
              n = 0
            ;(r = !1), clearTimeout(g.performance.timer), e.each(s, function(
              e,
              t
            ) {
              n += t['Execution Time']
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.state = function(t) {
    var i,
      o = e(this),
      a = o.selector || '',
    ...
    return o.each(function() {
      ...
      ;(n = {
        initialize: function() {
          n.verbose('Initializing module'), d.automatic &&
            n.add.defaults(), d.context && '' !== a
            ? e(d.context)
            ...
            : x
                ...
                .on('click' + b, n.toggle.state), n.instantiate()
        },
        instantiate: function() {
        ...
        listenTo: function(t) {
          n.debug('API request detected, waiting for state signal', t), t &&
            (
        ...
        change: {
          state: function() {
            n.debug('Determining state change direction'), n.is.inactive()
              ? n.activate()
              : n.deactivate(), d.sync && n.sync(), d.onChange.call(C)
          },
          text: function() {
            n.is.textEnabled() &&
              (n.is.disabled()
        ...
        sync: function() {
          n.verbose('Syncing other buttons to current state'), n.is.active()
        ...
        flash: {
          text: function(e, t, i) {
            var o = n.get.text()
            n.debug('Flashing text message', e, t), (e =
              e || d.text.flash), (t = t || d.flashDuration), (i =
              i || function() {}), n.update.text(e), setTimeout(function() {
          ...
          text: function() {
            ...
            n.is.textEnabled() &&
              (n.is.active() && e
                ...
                : t &&
                  (n.verbose('Resetting inactive text', e), n.update.text(t)))
          }
        },
        update: {
          text: function(e) {
        ...
        performance: {
          ...
          display: function() {
            var t = d.name + ':',
              i = 0
            ;(r = !1), clearTimeout(n.performance.timer), e.each(s, function(
              e,
              t
            ) {
              i += t['Execution Time']
        ...
        invoke: function(t, o, a) {
          var r,
            ...
            l,
            c = w
          return (o = o || u), (a = C || a), 'string' == typeof t &&
            void 0 !== c &&
            (
              (t = t.split(/[\. ]/)),
              (r = t.length - 1),
              e.each(t, function(i, o) {
                var a =
                  i != r
                    ? o + t[i + 1].charAt(0).toUpperCase() + t[i + 1].slice(1)
                    : t
  ...
  ;(t =
    void 0 !== t && t.Math == Math
      ...
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.visibility = function(i) {
    var o,
      a = e(this),
      r = a.selector || '',
      s = new Date().getTime(),
      ...
      ;(p = {
        initialize: function() {
          p.debug(
            'Initializing',
            h
          ), p.setup.cache(), p.should.trackChanges() &&
            (
              'image' == h.type && p.setup.image(),
              'fixed' == h.type && p.setup.fixed(),
              h.observeChanges && p.observeChanges(),
              p.bind.events()
            ), p.save.position(), p.is.visible() ||
            p.error(x.visible, T), h.initialCheck &&
            p.checkVisibility(), p.instantiate()
        },
        instantiate: function() {
          p.debug('Storing instance', p), T.data(k, p), (R = p)
        },
        destroy: function() {
          p.verbose('Destroying previous module'), v && v.disconnect(), g &&
            g.disconnect(), S.off('load' + w, p.event.load).off(
            'resize' + w,
            p.event.resize
            ...
            (p.resetFixed(), p.remove.placeholder()), T.off(w).removeData(k)
        },
        observeChanges: function() {
          'MutationObserver' in t &&
            (
        ...
        bind: {
          events: function() {
            ...
            ), h.refreshOnLoad && S.on('load' + w, p.event.load), S.on(
              'resize' + w,
              p.event.resize
            ), A.off('scroll' + w)
        ...
        precache: function(t, i) {
          ...
          for (
            ...
            (s = n.createElement(
              'img'
            )), (s.onload = l), (s.onerror = l), (s.src = t[o]), r.push(s)
        },
        ...
        setup: {
                ...
                (h.onOnScreen = function() {
                  p.debug('Image on screen', E), p.precache(e, function() {
                    p.set.image(e, function() {
                      m++, m == f &&
                        h.onAllLoaded.call(this), h.onLoad.call(this)
                    })
                  })
                })
              )
          ...
          fixed: function() {
            p.debug(
              'Setting up fixed'
            ), (h.once = !1), (h.observeChanges = !1), (h.initialCheck = !0), (h.refreshOnLoad = !0), i.transition ||
              (h.transition = !1), p.create.placeholder(), p.debug(
              'Added placeholder',
              a
              ...
              p.debug(
                ...
                T
              ), p.show.placeholder(), p.set.fixed(), h.transition &&
                void 0 !== e.fn.transition &&
              ...
              p.debug(
                ...
                T
              ), p.hide.placeholder(), p.remove.fixed()
            })
          }
        },
        create: {
          placeholder: function() {
            p.verbose('Creating fixed position placeholder'), (a = T.clone(!1)
              .css('display', 'none')
        ...
        show: {
          placeholder: function() {
            p.verbose('Showing placeholder'), a
              .css('display', 'block')
        ...
        hide: {
          placeholder: function() {
            p.verbose('Hiding placeholder'), a
              .css('display', 'none')
              .css('visibility', '')
          }
        },
        set: {
          fixed: function() {
            p.verbose('Setting element to fixed position'), T.addClass(
              b.fixed
            ).css({
              position: 'fixed',
              top: h.offset + 'px',
        ...
        refresh: function() {
          p.debug('Refreshing constants (width/height)'), 'fixed' == h.type &&
            p.resetFixed(), p.reset(), p.save.position(), h.checkOnRefresh &&
            p.checkVisibility(), h.onRefresh.call(E)
        },
        resetFixed: function() {
          p.remove.fixed(), p.remove.occurred()
        },
        reset: function() {
          p.verbose('Resetting all cached values'), e.isPlainObject(p.cache) &&
            ((p.cache.screen = {}), (p.cache.element = {}))
        },
        checkVisibility: function(e) {
          p.verbose('Checking visibility of element', p.cache.element), !F &&
            p.is.visible() &&
            (
              p.save.scroll(e),
              p.save.calculations(),
        ...
        passing: function(e) {
          ...
          if (
            (
              e &&
                (p.debug('Adding callback for passing', e), (h.onPassing = e)),
              t.passing
                ? p.execute(n, 'passing')
        ...
        save: {
          calculations: function() {
            ...
            ), p.save.direction(), p.save.screenCalculations(), p.save.elementCalculations()
          },
          occurred: function(e) {
            e &&
              ((void 0 !== p.cache.occurred[e] && p.cache.occurred[e] === !0) ||
                (
          ...
          scroll: function(e) {
            ;(e =
              e + h.offset || A.scrollTop() + h.offset), (p.cache.scroll = e)
          },
          direction: function() {
            var e,
              t = p.get.scroll(),
            ...
            return (e =
              t > n && n
                ? 'down'
                : t < n && n ? 'up' : 'static'), (p.cache.direction = e), p
              .cache.direction
          },
          elementPosition: function() {
            var e = p.cache.element,
              t = p.get.screenSize()
            return p.verbose('Saving element position'), (e.fits =
              e.height <
              t.height), (e.offset = T.offset()), (e.width = T.outerWidth()), (e.height = T.outerHeight()), p.is.verticallyScrollableContext() &&
              (e.offset.top +=
                A.scrollTop() -
                A.offset().top), p.is.horizontallyScrollableContext() &&
              (e.offset.left +=
                A.scrollLeft - A.offset().left), (p.cache.element = e), e
          },
          elementCalculations: function() {
            ...
            return h.includeMargin
              ...
              : (
                ...
                ), (t.topPassed = e.top >= t.top), (t.bottomPassed =
              e.top >= t.bottom), (t.topVisible =
              e.bottom >= t.top && !t.bottomPassed), (t.bottomVisible =
              e.bottom >= t.bottom &&
              !t.topPassed), (t.pixelsPassed = 0), (t.percentagePassed = 0), (t.onScreen =
              t.topVisible && !t.bottomPassed), (t.passing =
              t.topPassed &&
              !t.bottomPassed), (t.offScreen = !t.onScreen), t.passing &&
              (
                (t.pixelsPassed = e.top - t.top),
                (t.percentagePassed = (e.top - t.top) / t.height)
              ), (p.cache.element = t), p.verbose(
          ...
          screenCalculations: function() {
            var e = p.get.scroll()
            return p.save.direction(), (p.cache.screen.top = e), (p.cache.screen.bottom =
              e + p.cache.screen.height), p.cache.screen
          },
          screenSize: function() {
        ...
        get: {
          ...
          direction: function() {
            return void 0 === p.cache.direction && p.save.direction(), p.cache
              .direction
          },
          elementPosition: function() {
            return void 0 === p.cache.element && p.save.elementPosition(), p
              .cache.element
          },
          elementCalculations: function() {
            return void 0 === p.cache.element && p.save.elementCalculations(), p
              .cache.element
          },
          screenCalculations: function() {
            return void 0 === p.cache.screen && p.save.screenCalculations(), p
              .cache.screen
          },
          screenSize: function() {
            return void 0 === p.cache.screen && p.save.screenSize(), p.cache
              .screen
          },
          scroll: function() {
          ...
          lastScroll: function() {
            return void 0 === p.cache.screen
              ? (
                  p.debug('First scroll event, no last scroll could be found'),
                  !1
                )
              : p.cache.screen.top
          }
        ...
        performance: {
          ...
          display: function() {
            var t = h.name + ':',
              n = 0
            ;(s = !1), clearTimeout(p.performance.timer), e.each(l, function(
              e,
              t
            ) {
              n += t['Execution Time']
